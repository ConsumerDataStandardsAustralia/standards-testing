...
Some of the test cases in the Postman Collection links to the associated CDR Test Documentation scenario. For example, the test case [T.EAR.0002](https://www.postman.com/data-standards-body/cdr-tests/request/h3k195i/get-service-points-with-pagination) shows a real-world implementation with code examples under the Test tab in Postman, with its [detailed documentation](https://consumerdatastandardsaustralia.github.io/standards-testing/latest/#testcase-t.ear.0002) accessible in the CDR Test Documentation. 
